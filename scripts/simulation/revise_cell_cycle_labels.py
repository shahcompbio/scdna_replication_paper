...
def remove_low_quality_cells(cn):
    ...
    low_qual_cells = cn.loc[(cn['rep_auto']>0.2) | (cn['frac_cn0']>0.05)].cell_id.unique()
...
if __name__ == '__main__':
    ...
    # add a column to denote their true cell cycle phase
    cn_s['true_phase'] = 'S'
    cn_g['true_phase'] = 'G1/2'
    ...
    cn_filtered['PERT_phase'] = 'S'
    cn_nonrep['PERT_phase'] = 'G1/2'
    cn_lowqual['PERT_phase'] = 'LowQual'
