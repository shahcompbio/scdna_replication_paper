...
def plot_ccc_distributions(cell_metrics, argv):
    ...
    sns.histplot(data=cell_metrics, x='corrected_madn', hue='is_s_phase_new', multiple='stack', ax=ax[0])
    sns.histplot(data=cell_metrics, x='lrs', hue='is_s_phase_new', multiple='stack', ax=ax[1])
    sns.histplot(data=cell_metrics, x='corrected_breakpoints', hue='is_s_phase_new', multiple='stack', ax=ax[2])
    ...
    sns.scatterplot(data=cell_metrics, x='corrected_madn', y='lrs', hue='is_s_phase_new', alpha=0.3, ax=ax[0])
    sns.scatterplot(data=cell_metrics, x='corrected_breakpoints', y='lrs', hue='is_s_phase_new', alpha=0.3, ax=ax[1])
    sns.scatterplot(data=cell_metrics, x='corrected_breakpoints', y='corrected_madn', hue='is_s_phase_new', alpha=0.3, ax=ax[2])
    sns.scatterplot(data=cell_metrics, x='corrected_madn', y='lrs', hue='library_id', alpha=0.3, ax=ax[3])
    sns.scatterplot(data=cell_metrics, x='corrected_breakpoints', y='lrs', hue='library_id', alpha=0.3, ax=ax[4])
    sns.scatterplot(data=cell_metrics, x='corrected_breakpoints', y='corrected_madn', hue='library_id', alpha=0.3, ax=ax[5])
