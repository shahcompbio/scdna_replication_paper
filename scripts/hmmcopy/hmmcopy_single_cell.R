...
spec = matrix(c(
                ...
                "param_m",      "m",    2, "character", "optional m median prior parameter, comma-separated list of length num_states",
                "param_eta",      "eta",    2, "character",    "optional eta parameter",
                "param_g",      "g",    2, "double",    "optional g parameter, prior shape on lambda, which is gamma distributed",
