...
def get_args():
    ...
    p.add_argument('s_phase', help='input cell_id to clone_id csv file for s phase cells')
    p.add_argument('non_s_phase', help='input cell_id to clone_id csv file for non s phase cells')
