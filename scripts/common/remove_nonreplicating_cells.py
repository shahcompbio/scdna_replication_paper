...
def get_args():
    ...
    p.add_argument('output_nonrep', type=str, help='pyro model results for nonreplicating cells that get removed')
...
if __name__ == '__main__':
    ...
    cn = compute_quality_features(cn, rep_state_col='model_rep_state', cn_state_col='model_cn_state', rpm_col='rpm')
    ...
    cn_nonrep.to_csv(argv.output_nonrep, sep='\t', index=False)
